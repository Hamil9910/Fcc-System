...
function Configurator() {
  ...
  return (
    <ConfiguratorRoot variant="permanent" ownerState={{ openConfigurator }}>
      ...
      >
        <SoftBox>
          <SoftTypography variant="h5">Parametrizador UI</SoftTypography>
      ...
      <SoftBox pt={1.25} pb={3} px={3}>
        <SoftBox>
          <SoftTypography variant="h6">Colores De la barra</SoftTypography>
        ...
        <SoftBox mt={3} lineHeight={1}>
          <SoftTypography variant="h6">Tipo de barra de navegacion</SoftTypography>
          <SoftTypography variant="button" color="text" fontWeight="regular">
            Elija entre 2 tipos diferentes.
          </SoftTypography>
