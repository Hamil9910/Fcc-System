...
function MedicoModalsUpdate(idEnfermedad, { onClose }) {
      ...
      if (idMedico) {
        try {
          const respuesta = await axios.get(
            `http://localhost:5000/api/fcc/medicos/${idMedico.idMedico}`
          );
          setFormData(respuesta.data);
        } catch (error) {
          console.error("Error al cargar a los medicos", error);
        }
      }
    };
    cargarDatosMedicos().then((res) => {
      setIsLoading(true);
    });
  ...
  const enviarDatos = async () => {
    ...
    await axios
      .put(`http://localhost:5000/api/fcc/medicos/${idMedico.idMedico}`
      , dataParaEnviar
      )
      // Muestra un mensaje de éxito
      .then(function (response) {
        toast.title = "¡Éxito!";
        toast.text = "Enfermedad modificada correctamente";
        toast.icon = "success";
      })
      // Muestra un mensaje de error
      .catch((error) => {
        toast.title = "¡Error!";
        toast.text = "Hubo un problema al modificar la enfermedad";
        toast.icon = "error";
      })
      .finally(() => {
        Swal.fire({
    ...
    <Modal
      ...
      <Box sx={style}>
        ...
        <TextField
          ...
          helperText={errors.nombres_medico ? "* Obligatorio - Solo admite letras." : ""}
        ...
        <TextField
          ...
          helperText={errors.apellidos_medico ? "* Obligatorio - Solo admite letras." : ""}
          onChange={handleChange}
        ...
        <TextField
          ...
          helperText={errors.cedula_medico ? "* Obligatorio - Solo admite números." : ""}
          onChange={handleChange}
        ...
        <TextField
          ...
          helperText={errors.telefono_medico ? "* Obligatorio - Solo admite números." : ""}
          onChange={handleChange}
        ...
        <TextField
          ...
          helperText={errors.titulos_medico ? "* Obligatorio - Solo admite letras." : ""}
          onChange={handleChange}
...
MedicoModalsUpdate.propTypes = {
  onClose: PropTypes.func.isRequired,
};

export default MedicoModalsUpdate;
