...
function EspecialidadModalsForm({ onClose }) {
  ...
  const enviarDatos = async () => {
    ...
    try {
      await axios
        .post("http://localhost:5000/api/fcc/especialidad", dataParaEnviar)
      // Muestra un mensaje de éxito
      Swal.fire({
        title: "¡Éxito!",
        text: "Especialidad agregado correctamente",
        icon: "success",
...
EspecialidadModalsForm.propTypes = {
  onClose: PropTypes.func.isRequired,
};

export default EspecialidadModalsForm;
